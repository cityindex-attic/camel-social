...
Vagrant::Config.run do |config|
  ...
  #config.vm.box_url = "https://s3-eu-west-1.amazonaws.com/pressupbox/pressupbox_v2.box"
  ...
  config.vm.share_folder("home-camel-social", "/home/vagrant/camel-social", ".", :nfs => true)
